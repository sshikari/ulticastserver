...
<%@ page import="com.ulticast.domain.Team" %>
<html>
    <head>
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="team.teamName.label" default="Team Name" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: teamInstance, field: "teamName")}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" style="text-align: left;" class="value">
                                ...
                                <g:each in="${teamInstance.players}" var="p">
                                    <li><g:link controller="player" action="show" id="${p.id}">${p.nickname}</g:link></li>
                                </g:each>
                                </ul>
                            </td>
